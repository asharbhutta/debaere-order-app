    ...
    <Modal key={'OrderModal'} visible={visible}>
      ...
      >
        ...
        >
          ...
          <Button
            buttonStyle={{ paddingHorizontal: 10, margin: 10, marginTop: 20 , backgroundColor: 'transparent', borderColor: COLORS.accent, borderWidth: 1, display: varifiedDate == null ? "none" : "flex",}}
